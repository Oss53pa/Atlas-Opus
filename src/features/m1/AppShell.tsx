...
const FAMILIES: FamilyDef[] = [
  {
    ...
    modules: [
      ...
      { code: 'JUR', labelKey: 'mod.montage', route: 'montage' },
  ...
  },
  {
    ...
    modules: [
      ...
      { code: 'CRIT', labelKey: 'mod.criteres', route: 'criteres' },
      { code: 'NOTE', labelKey: 'mod.notation', route: 'notation' },
  ...
  },
  {
    ...
    modules: [
      ...
      { code: 'EIES', labelKey: 'mod.eies', route: 'eies' },
      { code: 'PGES', labelKey: 'mod.pges', route: 'pges' },
      ...
      { code: 'PAT', labelKey: 'mod.patrimoine', route: 'patrimoine' },
